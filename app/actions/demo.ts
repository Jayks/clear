...
export async function ensureDemoGroup() {
  ...
  try {
    ...
    const NEST_SEED_VERSION = "A pre-loaded sample nest — explore nest splitting freely!";
    ...
    // Swallow transient DB errors — seed failures must never break the groups page.
  }
}
