...
export const metadata: Metadata = { title: "Refund & Cancellation Policy — ClearOff" };

export default function RefundPage() {
  return (
    <LegalPageShell title="Refund & Cancellation Policy" updated="19 June 2026">
      <p>
        This policy covers <strong>ClearOff Plus</strong> pass purchases — the only payments ClearOff processes
        directly. It does not cover money exchanged between users for expense settlements; ClearOff has no part in
        that (see our <a href="/terms">Terms</a>, §1).
      </p>

      <h2>1. Nothing to cancel — passes aren&apos;t subscriptions</h2>
      <p>
        ClearOff Plus is sold as a one-time <strong>30-day pass</strong> or <strong>annual pass</strong>. No card is
      ...
      <ul>
        ...
        <li>Payment was deducted from your account, but ClearOff Plus was never activated due to a technical error on our side.</li>
        <li>The charge was unauthorized or fraudulent on your account.</li>
      </ul>
      <p>
        Contact us within 7 days of the charge at{" "}
        <a href="mailto:support@clearoff.in">support@clearoff.in</a> with your payment ID or order ID
      ...
      <p>
        Email <a href="mailto:support@clearoff.in">support@clearoff.in</a> with the subject "Refund
