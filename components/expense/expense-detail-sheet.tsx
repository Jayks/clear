...
import { X, Pencil, Loader2, CheckCircle2, XCircle, Clock } from "lucide-react";
...
function CommentSkeleton() {
  return (
    <div className="space-y-3">
      {/* Other user bubble (left) */}
      <div className="flex items-end gap-1.5">
        <div className="w-7 h-7 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse shrink-0 mb-5" />
        <div className="w-5 shrink-0" />
        <div className="flex flex-col gap-0.5">
          <div className="h-2.5 w-14 rounded bg-slate-200 dark:bg-slate-700 animate-pulse mx-3 mb-0.5" />
          <div className="h-8 w-44 rounded-2xl rounded-bl-sm bg-slate-100 dark:bg-slate-800 animate-pulse" />
          <div className="h-2 w-16 rounded bg-slate-200 dark:bg-slate-700 animate-pulse mx-3 mt-1" />
        </div>
      </div>
      {/* Own bubble (right) */}
      <div className="flex items-end gap-1.5 flex-row-reverse">
        ...
        <div className="flex flex-col gap-0.5 items-end">
          <div
            className="h-8 w-36 rounded-2xl rounded-br-sm animate-pulse"
            style={{ background: "rgba(6,182,212,0.15)" }}
          />
          <div className="h-2 w-12 rounded bg-slate-200 dark:bg-slate-700 animate-pulse mx-3 mt-1" />
        </div>
      </div>
    </div>
  );
