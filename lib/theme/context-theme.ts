...
export const CONTEXT_THEME: Record<ContextKey, ContextTheme> = {
  trip: {
    ...
    rule: "from-cyan-300/80 to-transparent dark:from-cyan-700/50 dark:to-transparent",
  ...
  nest: {
    ...
    rule: "from-emerald-300/80 to-transparent dark:from-emerald-700/50 dark:to-transparent",
  ...
  stream: {
    ...
    rule: "from-blue-300/80 to-transparent dark:from-blue-700/50 dark:to-transparent",
  ...
  circle_recurring: {
    ...
    rule: "from-violet-300/80 to-transparent dark:from-violet-700/50 dark:to-transparent",
  ...
  circle_onetime: {
    ...
    rule: "from-amber-300/80 to-transparent dark:from-amber-700/50 dark:to-transparent",
